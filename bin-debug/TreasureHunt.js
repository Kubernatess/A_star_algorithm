...
var TreasureHunt = (function (_super) {
    ...
    TreasureHunt.prototype.$onAddToStage = function (stage, nest) {
        ...
        this.gridList.addEventListener(eui.ItemTapEvent.ITEM_TAP, this.moveToLocation, this);
        this.once(egret.Event.REMOVED_FROM_STAGE, this.onRemoveFromStage, this);
    };
    TreasureHunt.prototype.onRemoveFromStage = function () {
        this.gridList.removeEventListener(eui.ItemTapEvent.ITEM_TAP, this.moveToLocation, this);
        egret.Tween.removeAllTweens();
    };
    TreasureHunt.prototype.moveToLocation = function () {
        var _this = this;
    ...
    TreasureHunt.prototype.A_star_algorithm = function (myPos, target) {
        ...
        var parentNodeList = {};
        openList.push(myPos);
        while (openList.indexOf(target) == -1) {
